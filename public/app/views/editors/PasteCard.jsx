...
export default class PasteCard extends React.Component {
  constructor(props){
    super(props);
    this.state = {
  ...
  render() {
    ...
    return(
      <div style={{minHeight: "20vh"}}>
        ...
        <div style={{minHeight: "15vh", padding: "0.5vh 0", marginBottom: "2%", boxSizing: "border-box"}}>
          {noneTextPreview}
          <MainEditor
